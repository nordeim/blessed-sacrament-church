...
- All five gates are green: `pnpm lint` (0) + `pnpm typecheck` (0) + `pnpm test` (26 files / 144 tests) + `pnpm test:e2e` (51/51, BSC) + `pnpm build` (~467kB); sixth check `pnpm test:e2e:built` 51/51 (built artifact).
