...
const items = [
  ...
  { id: "q2", question: "Q2 When is confession?", answer: "A2 15 minutes before weekend Masses." },
  { id: "q3", question: "Q3 How do I get there?", answer: "A3 1 Commonwealth Drive, Singapore 149603." },
];
